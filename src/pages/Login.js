        ...
        <div className="container">
          <Row>
            <Col xs={12} md={6} className="log-left">
              ...
              <h2 className="text-white mt-2 pt-4 text-center"
                style={{ fontFamily: "sans-serif" }}
              >
                Good To See You Again.
              </h2>
              <br />
              <p className="text-white" style={{ fontFamily: "sans-serif" }}>By Logging Into Time Tracer <br /> You Accept Our <Link style={{ color: "white" }}>Terms Of Use</Link> And <Link style={{ color: "white" }}>Privacy Policy</Link> </p>
